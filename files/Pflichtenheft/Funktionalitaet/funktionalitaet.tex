...
\textbf{/F201/} Jedes Neuronale Netz kann mit dem Gradient-Abstieg-Algorithmus trainiert werden. Dabei sind die Trainingsparameter \emph{Lernrate}, \emph{Stapelgröße}, \emph{Anzahl der Trainingsbilder} und \emph{Zyklenanzahl} frei wählbar. Das Training kann manuell gestartet und gestoppt werden.

\textbf{/F202/} Ein trainiertes Neuronales Netz kann bei Bedarf gespeichert werden.
